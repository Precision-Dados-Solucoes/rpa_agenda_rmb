...
interface GraficoRetornosExecutanteProps {
...
export default function GraficoRetornosExecutante({ filtros }: GraficoRetornosExecutanteProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Visão de Retornos por Executante</CardTitle>
        {total > 0 && (
