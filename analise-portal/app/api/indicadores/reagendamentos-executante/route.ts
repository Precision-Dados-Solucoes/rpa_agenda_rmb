...
/**
 * GET /api/indicadores/reagendamentos-executante
 * Retorna contagem de andamentos tipo "5. Reagendamento" por executante
 */
export async function GET(request: NextRequest) {
  try {
    ...
    // Buscar andamentos do tipo "5. Reagendamento"
    const andamentos = await prisma.andamentoBase.findMany({
      where: {
        tipo_andamento: '5. Reagendamento',
      },
      select: {
    ...
    console.log('[DEBUG reagendamentos-executante]', serializeForLog({
    ...
    console.log('[DEBUG reagendamentos-executante] Após buscar agendas:', {
    ...
    console.log('[DEBUG reagendamentos-executante] Resultado final:', {
    ...
    console.error('Erro ao buscar dados de reagendamentos por executante:', error)
    return NextResponse.json(
      {
        error: 'Erro ao buscar dados de reagendamentos por executante',
